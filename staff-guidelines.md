...
Following the social contract should be one of the considerations of “performance grading” for staff.
...
- Opinions change - people should respect that, but also be ready to defend their position when pressed on the topic, but it must all be done respectfully.
- People have a right to their opinions, and if the explanation of their opinion is not to your liking, you must still respect that outcome. Defer to voting if necessary.
...
2. Submit an anonymous or non-anonymous [form](https://dyno.gg/form/aef8feab) that is visible to all Core members.

Regardless of where a report originates, each report will all be handled by non-offending Core members.

### Follow-up for non-anonymous reports
